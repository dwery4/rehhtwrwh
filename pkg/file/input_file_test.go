...
func TestInputFileMultipleFilesWithRequestsOnly(t *testing.T) {
	...
	file1.Write([]byte(proto.PayloadSeparator))
	...
	file2.Write([]byte(proto.PayloadSeparator))
...
func TestInputFileRequestsWithLatency(t *testing.T) {
	...
	file.Write([]byte(proto.PayloadSeparator))
...
func ReadFromCaptureFile(captureFile *os.File, count int, callback test.WriteCallback) (err error) {
